		...
		<main id="main" class="site-main">
                ...
                <div class="error">
                    <div class="error__wrapper">
                        ...
                        <div class="error__bth">
                            <a class="_button text" href="<?php echo home_url('/');?>">
                                НА ГОЛОВНУ
                            </a>
                        </div>
                    </div>
...
//						$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'estore' ), convert_smilies( ':)' ) ) . '</p>';
