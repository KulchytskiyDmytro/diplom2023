...
<div class="recomend-slider__slide">
    <div data-prodid="3" class="product-card">
        <div class="product-card__wrapper">
            ...
            ///==================================================out of stock lable div
            if (!$product->is_in_stock()) {
                global $product;
                $link = apply_filters( 'woocommerce_loop_product_link', get_the_permalink(), $product );
                echo '<a href="' . esc_url( $link ) . '" class="product-card__unavailable">';
             ...
             */
            remove_action('woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_rating', 5); // remove
